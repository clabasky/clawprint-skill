...
name: clawprint
description: |
  Create and operate sponsored business entities (LLCs) for AI agents. 
  Use when an agent needs to: Form a legal business entity, open a bank account, 
  accept payments or generate invoices, track business financials, or operate as 
  an independent economic agent with human sponsor oversight.
---
